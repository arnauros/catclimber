...
function plotRoute(start, end) {
  const directionsRequest = `https://api.mapbox.com/directions/v5/mapbox/driving/${start[0]},${start[1]};${end[0]},${end[1]}?geometries=geojson&access_token=${mapboxToken}`;
  ...
  fetch(directionsRequest)
    ...
    .then((data) => {
      if (data.routes && data.routes.length > 0) {
        ...
        console.log("Route plotted on the map.");
      } else {
...
// Example usage of plotRoute function
plotRoute([2.154007, 41.390205], [2.177432, 41.382894]); // Example coordinates
